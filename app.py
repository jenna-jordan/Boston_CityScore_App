...
if menu == "About this App":
    ...
    Hi! My name is Jenna Jordan, and I created this Streamlit app. You can learn more about me at my website, [jennajordan.me](https://jennajordan.me)
    """
    )
elif menu == "Current Scores":
